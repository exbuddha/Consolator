...
import net.consolator.database.entity.NetworkEntity
import net.consolator.database.entity.NetworkStateEntity
import net.consolator.netDb
import net.consolator.network
import net.consolator.session

@Dao
internal abstract class NetworkDao {
    ...
    companion object {
        suspend operator fun <R> invoke(block: suspend NetworkDao.() -> R) =
